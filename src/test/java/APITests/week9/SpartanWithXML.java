...
public class SpartanWithXML extends SpartanAuthTestBase {
    ...
    public void getSpartanXml(){
        ...
        //verify first spartan name is Meade
                ...
                .then()
                        ...
                        .body("List.item[1].gender",is("Male"))
                        .log().all();
    ...
    public void testXmlPath(){
        ...
        //get tenth spartan name
        String name = xmlPath.getString("List.item[9].name");
        System.out.println("name = " + name);
        //get the 13th spartan id number
        int id = xmlPath.getInt("List.item[12].id");
